...
```bash
rock-paper-scissors$ sam build --use-container
```
...
```bash
rock-paper-scissors$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
rock-paper-scissors$ sam logs -n HelloWorldFunction --stack-name rock-paper-scissors --tail
```
...
```bash
rock-paper-scissors$ pip install pytest pytest-mock --user
rock-paper-scissors$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name rock-paper-scissors
```
